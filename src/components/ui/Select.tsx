...
const Select = SelectPrimitive.Root as <T>(
    props: SelectPrimitive.SelectRootProps<T> & { children?: JSX.Element }
) => JSX.Element;
const SelectValue = SelectPrimitive.Value as <T>(props: SelectPrimitive.SelectValueProps<T>) => JSX.Element;
...
const SelectDescription = <T extends ValidComponent = "div">(props: PolymorphicProps<T, SelectDescriptionProps<T>>) => {
    ...
    return (
        <SelectPrimitive.Description class={cn(labelVariants({ variant: "description" }), local.class)} {...others} />
    );
};
